...
export const SOLANA = {
	...
	explorerBlockUrl: "https://explorer.consensus.mainnet.sol.network/blocks",
	explorerBlocksUrl: "https://explorer.consensus.mainnet.solnetwork/blocks",
	explorerAddressUrl: "",
	liveTxs: [],
	liveBlocks: [],
	houseArray: [],
	...
	stats: Vue.observable({
		...
		"medianFee-usd": {
			title: () => {
				return i18n.t("sol.medianFee-usd");
			},
			signTitle: "Median Contract Fee",
			before: "~$",
			after: " USD",
		...
		"medianFee-gasPrice": {
			title: () => {
				return i18n.t("sol.medianFee-gasPrice");
			},
			value: false,
			socket: true,
			format: (val) => {
		...
		"fiatPrice-usd": {
			title: () => {
				return i18n.t("sol.fiatPrice-usd");
			},
			decimals: 2,
			before: "$",
			socket: true,
